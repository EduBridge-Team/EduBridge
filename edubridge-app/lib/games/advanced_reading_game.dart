  ...
  void _choose(int option) {
    ...
    Future.delayed(const Duration(milliseconds: 900), () async {
      ...
      if (_index == _items.length - 1) {
        await VisualCelebration.show(context, message: 'فهم قرائي رائع! $_score من ${_items.length}', icon:Icons.book_sharp, childName: widget.childName, duration: const Duration(seconds: 3));
