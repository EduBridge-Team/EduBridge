...
php artisan tinker --execute="DB::unprepared(file_get_contents('database/upgrade_learning_support_requests.sql')); echo 'db-learning-support-requests-ok';"
php artisan tinker --execute="DB::unprepared(file_get_contents('database/upgrade_lesson_media.sql')); echo 'db-lesson-media-ok';"
php artisan tinker --execute="DB::unprepared(file_get_contents('database/upgrade_specialist_workflow.sql')); echo 'db-specialist-workflow-ok';"
php artisan tinker --execute="DB::unprepared(file_get_contents('database/upgrade_learning_support_meetings.sql')); echo 'db-learning-support-meetings-ok';"
