...
export default function TopBar() {
  ...
  const stripLinks = [
    ...
    { to: '/accessibility', label: 'إعدادات الوصول', Icon: Accessibility, show: is('parent', 'teacher', 'specialist', 'admin') },
    { to: '/search', label: 'البحث برقم الهوية', Icon: Search, show: is('teacher', 'specialist', 'admin', 'ministry', 'institution') },
    { to: '/consultations', label: 'دراسة الحالة', Icon: Stethoscope, show: is('parent', 'teacher', 'specialist', 'admin') },
